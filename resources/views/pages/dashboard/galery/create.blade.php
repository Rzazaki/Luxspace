                ...
                @csrf
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="file" multiple accept="image/*" name="files[]" class="block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 leading-tight focus:outline-non focus:bg-white focus:border-gray-500" placeholder="Photos">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
